  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          Padding(
            padding: EdgeInsets.only(right: 8.0), // Jarak kanan
            child: Image.asset(
              'image/search.png',
              width: 30,
              height: 30,
      ...
      body: isLoading
          ...
          : ListView(
              ...
              children: [
                buildCategory("Popular Movies", popularMovies),
                buildCategory2("Upcoming Movies", upcomingMovies),
                buildCategory3("Top Rated", topRatedMovies),
                buildCategory4("Now Playing", nowPlayingMovies),
              ],
            ),
    );
  }
