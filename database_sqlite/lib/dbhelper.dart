...
class DbHelper {
  static DbHelper? _dbHelper_edo;
  static Database? _database_edo;
  ...
  factory DbHelper() {
    if (_dbHelper_edo == null) {
      _dbHelper_edo = DbHelper._createObject();
    }
    return _dbHelper_edo!;
  }

  Future<Database> get database async {
    if (_database_edo == null) {
      _database_edo = await initDb();
    }
    return _database_edo!;
  }
}
